			...
			<div class="row">
				<div class="col-md-5">
					<form action="../c/ajouter_objet.php" method="post">
						...
						<input type="text" name="mail" placeholder="Email Employé"value=""><br> 
						<input type="text" name="tel" placeholder="Téléphone" value=""><br>
				...
				<div class="col-md-3">
					<form action="../c/afficher_tout.php?n_page=" method="GET">
						<input type="hidden" name="page" value="employes">
						<input class="btn" type="submit" name="valider" value="Afficher Employés"><br>
						Triez par :
