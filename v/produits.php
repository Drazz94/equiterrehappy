			...
			<div class="row">
				<div class="col-md-5">
					<form action="../c/ajouter_objet.php" method="post">
						...
						<input type="number" name="quantite" placeholder="Quantité" value=""><br>
						<input type="float" name="prix_vente" placeholder="Prix Vente" value="">
						<input type="float" name="prix_achat" placeholder="Prix Achat" value=""><br>
						<input type="text" name="fournisseur" placeholder="Fournisseur" value=""><br>
				...
				<div class="col-md-3">
					<form action="../c/afficher_tout.php" method="GET">
						<input type="hidden" name="page" value="produits">
						<input class="btn" type="submit" name="valider" value="Afficher Produits"><br>
						Triez par :
